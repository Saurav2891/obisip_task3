package com.saurav_ranjan.calc;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener
{
    ...
    {
        buttonNumber0 = (Button) findViewById(R.id.zero);
        buttonNumber1 = (Button) findViewById(R.id.one);
        buttonNumber2 = (Button) findViewById(R.id.two);
        buttonNumber3 = (Button) findViewById(R.id.three);
        buttonNumber4 = (Button) findViewById(R.id.four);
        buttonNumber5 = (Button) findViewById(R.id.five);
        buttonNumber6 = (Button) findViewById(R.id.six);
        buttonNumber7 = (Button) findViewById(R.id.seven);
        buttonNumber8 = (Button) findViewById(R.id.eight);
        buttonNumber9 = (Button) findViewById(R.id.nine);

        buttonClear = (Button) findViewById(R.id.clear);
        buttonParentheses = (Button) findViewById(R.id.parentheses);
        ...
        buttonSubtraction = (Button) findViewById(R.id.subtraction);
        ...
        textViewInputNumbers = (TextView) findViewById(R.id.textView_numbers);
    }
